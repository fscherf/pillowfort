...
export class Engine {
  ...
  public engineElement: HTMLDivElement;
  ...
  constructor({
    ...
    this.engineElement = this.rootElement.querySelector(
      "div.engine",
    ) as HTMLDivElement;
    ...
    // finish
    // make HTML visible
    this.engineElement.style.display = "block";
  }
  ...
  // scaling
  public scale(): void {
    this.engineElement.style.width = "100%";
    this.engineElement.style.height = "100%";

    // We scale to a (presumably) lower resolution first so the engine HTML
    ...
    this.resize(
      this.engineElement.clientWidth,
      this.engineElement.clientHeight,
    );
  }
